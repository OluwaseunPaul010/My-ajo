...
export async function POST(req: NextRequest) {
  try {
    ...
    await prisma.user.update({
      where: { id: user.id },
      data: { emailVerifyToken: resetCode },
    });
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #ffffff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 16px 16px;">
            ...
            <p style="color: #6b7280; margin: 0 0 24px;">We received a request to reset your My Ajo password. Use the code below:</p>
            ...
            <p style="color: #6b7280; margin: 0 0 24px;">If you did not request this, please ignore this email.</p>
            <div style="background: #fef3c7; border-radius: 8px; padding: 12px; margin: 0 0 24px;">
              <p style="color: #92400e; margin: 0; font-size: 14px;">⚠️ Never share this code with anyone.</p>
            </div>

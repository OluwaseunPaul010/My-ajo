...
const transactions = [
  { type: "credit", desc: "Payout Received", group: "Family Ajo", amount: "+₦200,000", date: "May 15", status: "completed" },
  { type: "debit", desc: "Contribution", group: "Market Women Ajo", amount: "-₦16,000", date: "May 10", status: "completed" },
  { type: "debit", desc: "Contribution", group: "Family Ajo", amount: "-₦20,000", date: "May 1", status: "completed" },
  { type: "credit", desc: "Wallet Funding", group: "Bank Transfer", amount: "+₦50,000", date: "Apr 28", status: "completed" },
  { type: "debit", desc: "Contribution", group: "Office Savings", amount: "-₦10,000", date: "Apr 25", status: "pending" },
];

const groups = [
  { name: "Family Ajo", members: 10, contribution: "₦20,000", frequency: "Weekly", progress: 80, nextPayout: "May 15" },
  { name: "Market Women Ajo", members: 8, contribution: "₦16,000", frequency: "Weekly", progress: 60, nextPayout: "May 30" },
  { name: "Office Savings", members: 5, contribution: "₦10,000", frequency: "Monthly", progress: 40, nextPayout: "Jun 10" },
];
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="bg-white border-b border-gray-100 px-4 lg:px-8 py-4 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-900">Good morning, Chioma 👋</h1>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
              ...
              <div className="grid grid-cols-3 gap-3 mb-6">
                {[
                  ...
                  { icon: Users, label: "Join Group" },
                  { icon: ArrowUpRight, label: "Invite Friends" },
                  { icon: ArrowUpRight, label: "Send Money" },
                  { icon: Clock, label: "Request Extension" },
                  { icon: Bell, label: "View Reminders" },
                ].map((action, i) => (
                  <button key={i} className="flex flex-col items-center gap-2 p-3 rounded-xl hover:bg-emerald-50 transition-colors group">
                ...
                <div key={i} className="border border-gray-100 rounded-xl p-4 hover:border-emerald-200 hover:shadow-sm transition-all">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-400">{group.members} members · {group.frequency}</div>
                    </div>
                  </div>
                  <div className="w-full bg-gray-100 rounded-full h-1.5 mb-2">
                    <div className="bg-emerald-500 h-1.5 rounded-full" style={{ width: `${group.progress}%` }} />
                  </div>
                  <div className="flex items-center justify-between text-xs text-gray-400">
                    <span>{group.contribution}/cycle</span>
